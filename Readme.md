...
In Linux, you must download the ***2022*** version of the model, which is compatible to opencv 0.4.6 used in my OF 0.12.
...
In windows, the [face_detection_yunet_2023mar.onnx](https://github.com/opencv/opencv_zoo/tree/main/models/face_detection_yunet) file worked fine, since the opencv version seems to be 0.4.11
